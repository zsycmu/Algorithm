 ...
 * 
 * In fact, we can mark off multiples of 5 starting at 5 ¡Á 5 = 25, because 5 ¡Á 2 = 10 was already marked off by multiple of 2, similarly 5 ¡Á 3 = 15 was already marked off by multiple of 3. Therefore, if the current number is p, we can always mark off multiples of p starting at p2, then in increments of p: p2 + p, p2 + 2p, ... Now what should be the terminating loop condition?
 * 
 * It is easy to say that the terminating loop condition is p < n, which is certainly correct but not efficient. Do you still remember Hint #3?
 * 
 * Yes, the terminating loop condition can be p < ¡Ìn, as all non-primes ¡Ý ¡Ìn must have already been marked off. When the loop terminates, all the numbers in the table that are non-marked are prime.
 * 
